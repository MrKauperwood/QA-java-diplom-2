...
public final class Constants {
    ...
    public static final String INTERNAL_SERVER_ERROR_MSG = "Server returns 5** error. Fix it please";
    public static final String REQUIRED_FIELDS_ARE_EMPTY_MSG = "Email, password and name are required fields";
